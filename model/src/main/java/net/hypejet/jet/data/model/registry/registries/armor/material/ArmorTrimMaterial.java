 ...
 * @param overrideArmorMaterial assets for different types of armor materials, which override the asset specified
...
public record ArmorTrimMaterial(@NonNull Key asset, @NonNull Key ingredient, float itemModelIndex,
                                @NonNull Map<ArmorMaterialType, Key> overrideArmorMaterial,
    ...
    public ArmorTrimMaterial {
        ...
        NullabilityUtil.requireNonNull(overrideArmorMaterial, "override armor material");
        NullabilityUtil.requireNonNull(description, "description");
        overrideArmorMaterial = Map.copyOf(overrideArmorMaterial);
    }
