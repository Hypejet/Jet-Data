...
/**
 * Represents a {@linkplain RegistryEntryData registry entry data}, which holds a {@linkplain Biome biome}.
 *
 * @since 1.0
 * @author Codestech
 * @see Biome
 ...
 */
public final class BiomeRegistryEntryData extends RegistryEntryData<Biome> {
    /**
     ...
     * @since 1.0
     */
    public BiomeRegistryEntryData(@NonNull Key key, @NonNull DataPack knownPack, @NonNull Biome value) {
