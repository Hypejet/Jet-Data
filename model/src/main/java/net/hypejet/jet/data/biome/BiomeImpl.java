 ...
 * @param entitySpawnSettings entity spawn settings of the biome
 * @since 1.0
 * @author Codestech
 * @see Biome
 */
record BiomeImpl(@NonNull Key key, @NonNull ClimateSettings climate, @NonNull BiomeEffects effects,
                 @Nullable EntitySpawnSettings entitySpawnSettings) implements Biome {}