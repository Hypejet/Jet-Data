...
tasks.named<JavaExec>("run") {
    ...
    val resourcesSourcePath = prepareSourceSetPath(serverSourceSetContainer.resources)
    ...
    args(resourcesSourcePath.toString(), apiJavaSourcePath.toString(), serverJavaSourcePath.toString())
}
