 ...
 * @see Generator
 */
public final class VanillaEntityCategoryGenerator extends ConstantGenerator {

    private static final String PACKAGE = "net.hypejet.jet.data.entity.category";
    private static final String CLASS = "VanillaEntityCategories";
    ...
    /**
     * Constructs the {@linkplain VanillaEntityCategoryGenerator vanilla entity category generator}.
     *
     * @since 1.0
     */
    public VanillaEntityCategoryGenerator() {
        super(PACKAGE, CLASS_NAME, ENTITY_CATEGORY_CLASS,
                JavaDocBuilder.builder()
                        .line("Represents a built-in Minecraft entity category.")
